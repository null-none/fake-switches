...
```shell
$ docker run -P -d kal1sha/fake-switches
$ docker ps
CONTAINER ID        IMAGE                             COMMAND                  CREATED             STATUS              PORTS                     NAMES
6eec86849561        internap/fake-switches            "/bin/sh -c 'fake-swi"   35 seconds ago      Up 13 seconds       0.0.0.0:32769->22/tcp     boring_thompson
$ ssh 127.0.0.1 -p 32769 -l root
...
```shell
$ docker run -P -d -e SWITCH_MODEL="another_model" kal1sha/fake-switches
```
